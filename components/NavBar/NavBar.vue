<template>
	<view class="navbar" :class="{'border': showBorder}" :style="{'height': inner.navBarHeight + 'px', 'padding-top': inner.statusBarHeight + 'px', 'background-color': bgColor, 'border-color': borderColor }">
